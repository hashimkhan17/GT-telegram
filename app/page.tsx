  ...
  return (
    <div className="bg-[#1d2025] flex justify-center items-center h-screen">
      <div className="w-full max-w-xl text-white flex flex-col items-center">
        ...
        <h1 className="text-3xl font-bold mb-4">Welcome to GTap</h1>
        
        <p className="text-xl mb-6">The game is on the <Link href="/clicker" className="underline">GTap</Link> page.</p>
